...
import StripeIdCard from "./StripeId";

interface IconProps {
  size?: number;
}
export const SepaIcon: React.FC<IconProps> = ({ size }) => {
  return (
    <svg
      aria-hidden="true"
      className="SVGInline-svg SVGInline--cleaned-svg SVG-svg Icon-svg Icon--sepa-svg Icon-color-svg Icon-color--gray600-svg rounded"
      height={size ? size : "36"}
      width={size ? size : "36"}
      viewBox="0 0 32 32"
